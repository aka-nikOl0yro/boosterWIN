...
if %errorLevel% == 0 ( 
 if exist "REG" (
 echo Hai già eseguito questo programma. Per sucire chiudi il cmd.
...
choice /m "Disattivazione Windows Update automatico" /t 30 /d Y
echo %errorlevel%
if %errorlevel%==1 (
...
choice /m "Disattivazione Bing Search nel menu Start" /t 30 /d Y
echo %errorlevel%
if %errorlevel%==1 (
...
choice /m "Disattivazione delle app suggerite" /t 30 /d Y
echo %errorlevel%
if %errorlevel%==1 (
...
choice /m "Ripristino menu contestuale classico" /t 30 /d Y
echo %errorlevel%
if %errorlevel%==1 (
...
choice /m "Attivazione interfaccia ribbon classica in Esplora file" /t 30 /d Y
echo %errorlevel%
if %errorlevel%==1 (
...
choice /m "Disattivazione sfocatura schermata di blocco" /t 30 /d Y
echo %errorlevel%
if %errorlevel%==1 (
...
choice /m "make the taskbar clock show seconds" /t 30 /d Y
echo %errorlevel%
if %errorlevel%==1 (
...
choice /m "Disabilita il servizio di stampa" /t 30 /d Y
echo %errorlevel%
if %errorlevel%==1 (
...
timeout 7 > nul
rem echo Riavvio finale in 10 secondi...
rem shutdown /r /t 20